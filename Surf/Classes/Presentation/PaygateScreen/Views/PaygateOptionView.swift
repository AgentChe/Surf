...
private extension PaygateOptionView {
    ...
    func updateColors() {
        ...
        let contentColor = isSelected ? UIColor(red: 17 / 255, green: 17 / 255, blue: 17 / 255, alpha: 1) : UIColor.white
        ...
        saveLabel.textColor = isSelected ? UIColor.white : UIColor(red: 17 / 255, green: 17 / 255, blue: 17 / 255, alpha: 1)
