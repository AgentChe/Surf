...
private extension MyChatImageCell {
    func makeConstraints() {
        NSLayoutConstraint.activate([
            messageImageView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -16.scale),
            ...
            messageImageView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 80.scale),
