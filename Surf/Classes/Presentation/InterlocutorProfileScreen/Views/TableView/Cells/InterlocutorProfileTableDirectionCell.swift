//
//  InterlocutorProfileTableDirectionCell.swift
//  Surf
//
...
final class InterlocutorProfileTableDirectionCell: UITableViewCell {
    ...
    private var direction: InterlocutorProfileTableDirection!
    ...
    func setup(direction: InterlocutorProfileTableDirection, title: String, withIcon: Bool, maskedCorners: CACornerMask) {
...
private extension InterlocutorProfileTableDirectionCell {
    @objc
    func tapped() {
        actionDelegate?.interlocutorProfileTable(selected: direction)
    }
}
